...
- 6 карточек с цитатами участников (из Отзывы.md, Obsidian)
- Featured-карточка: Павел Белобородов, Executive консультант
- CSS: `.quotes-grid`, `.quote-card`, `.quote-featured` — inline в index.html
- Commit: `7032129`
